...
.routine-intro { display: flex; align-items: center; justify-content: space-between; gap: 12px; padding: 4px 2px; }.routine-eyebrow,.routine-block-title span,.routine-section__head > div > span { color: var(--color-primary-hover); font-size: 8px; font-weight: 900; letter-spacing: .1em; text-transform: uppercase; }.routine-intro h2 { margin-top: 2px; font-size: 18px; }.routine-intro p { margin-top: 3px; color: var(--color-text-secondary); font-size: 10px; }.routine-new { width: 38px; height: 38px; flex: 0 0 38px; border: 0; border-radius: 13px; background: var(--color-primary); color: var(--color-text-on-primary); font: inherit; font-size: 22px; cursor: pointer; box-shadow: var(--shadow-small); }
.player-hero { position: relative; isolation: isolate; display: grid; grid-template-columns: auto 1fr auto; align-items: center; gap: 11px; overflow: hidden; padding: 15px 13px 0; border: 1px solid var(--color-border); border-radius: 20px; background: var(--color-surface); color: var(--color-text-primary); box-shadow: var(--shadow-small); }.player-hero__glow { position: absolute; z-index: -1; width: 150px; height: 150px; right: -45px; top: -80px; border-radius: 50%; background: var(--color-primary-soft); }.player-avatar { position: relative; width: 64px; height: 64px; display: grid; place-items: center; border: 3px solid var(--color-surface); border-radius: 50%; background: var(--color-primary-soft); color: var(--color-primary); font-size: 23px; font-weight: 900; box-shadow: 0 0 0 4px var(--color-primary-soft); }.player-avatar img { position: absolute; inset: 0; width: 100%; height: 100%; border-radius: inherit; object-fit: cover; }.player-avatar b { position: absolute; right: -5px; bottom: -3px; min-width: 23px; height: 23px; display: grid; place-items: center; padding: 0 4px; border: 2px solid var(--color-surface); border-radius: 50%; background: var(--color-warning); color: var(--color-warning-text); font-size: 9px; }.player-identity { min-width: 0; }.player-kicker { display: block; overflow: hidden; color: var(--color-primary); font-size: 7px; font-weight: 900; letter-spacing: .07em; text-overflow: ellipsis; text-transform: uppercase; white-space: nowrap; }.player-identity h3 { overflow: hidden; margin: 3px 0 7px; font-size: 14px; text-overflow: ellipsis; white-space: nowrap; }.player-xp { height: 5px; overflow: hidden; border-radius: 9px; background: var(--color-surface-secondary); }.player-xp span { display: block; height: 100%; border-radius: inherit; background: var(--color-primary); transition: width .45s ease; }.player-identity small { display: block; margin-top: 4px; color: var(--color-text-secondary); font-size: 7px; }.player-power { width: 47px; height: 47px; display: flex; flex-direction: column; align-items: center; justify-content: center; border: 1px solid var(--color-border); border-radius: 14px; background: var(--color-primary-soft); }.player-power strong { font-size: 13px; }.player-power span { color: var(--color-primary); font-size: 6px; font-weight: 800; text-transform: uppercase; }.player-hero__stats { grid-column: 1/-1; display: grid; grid-template-columns: repeat(3,1fr); margin: 3px -13px 0; border-top: 1px solid var(--color-border); background: var(--color-surface-secondary); }.player-hero__stats span { padding: 9px 4px; border-right: 1px solid var(--color-border); color: var(--color-text-secondary); font-size: 7px; text-align: center; }.player-hero__stats span:last-child { border-right: 0; }.player-hero__stats b { color: var(--color-text-primary); font-size: 10px; }
.routine-create,.routine-section-create { display: grid; grid-template-columns: 1fr auto auto; gap: 7px; padding: 10px; border: 1px solid var(--color-border); border-radius: 15px; background: var(--color-surface); box-shadow: var(--shadow-small); }
.mission-heading { display: flex; align-items: center; justify-content: space-between; margin: 2px 2px -5px; }.mission-heading span { color: var(--color-primary-hover); font-size: 8px; font-weight: 900; letter-spacing: .09em; text-transform: uppercase; }.mission-heading small { color: var(--color-text-muted); font-size: 7px; }.routine-tabs { display: flex; gap: 7px; overflow-x: auto; padding: 2px 1px 5px; scrollbar-width: none; }.routine-tabs::-webkit-scrollbar { display: none; }.routine-tabs button { min-width: 145px; max-width: 175px; display: grid; grid-template-columns: 22px 1fr; gap: 1px 4px; padding: 9px 10px; border: 1px solid var(--color-border); border-radius: 14px; background: var(--color-surface); color: var(--color-text-secondary); text-align: left; cursor: pointer; box-shadow: var(--shadow-small); }.routine-tabs button.active { border-color: var(--color-primary); background: var(--color-primary-soft); color: var(--color-primary-hover); box-shadow: 0 5px 13px rgba(var(--color-primary-rgb),.14); }.routine-tabs b { grid-row: 1/3; align-self: center; color: var(--color-primary); font-size: 18px; text-align: center; }.routine-tabs span { overflow: hidden; font-size: 10px; font-weight: 800; text-overflow: ellipsis; white-space: nowrap; }.routine-tabs small { overflow: hidden; color: var(--color-text-muted); font-size: 7px; text-overflow: ellipsis; white-space: nowrap; }
...
.routine-eyebrow,.routine-block-title span,.routine-section__head > div > span,.mission-heading span { color:var(--color-primary);font-size:11px; }.routine-intro h2 { font-size:24px; }.routine-intro p { font-size:14px;line-height:1.4; }.routine-new { width:48px;height:48px;flex-basis:48px;border-radius:16px;box-shadow:var(--shadow-small); }
.player-hero { padding:18px 16px 0;border-radius:26px;box-shadow:var(--shadow-small); }.player-kicker { font-size:11px; }.player-identity h3 { font-size:18px; }.player-identity small { font-size:12px; }.player-power { width:56px;height:56px; }.player-power strong { font-size:16px; }.player-power span { font-size:9px; }.player-hero__stats { margin-inline:-16px; }.player-hero__stats span { padding:11px 4px;font-size:11px; }.player-hero__stats b { font-size:14px; }
.mission-heading small { font-size:11px; }.routine-tabs button { min-width:175px;min-height:66px;padding:11px 12px;border-radius:17px;box-shadow:none; }.routine-tabs span { font-size:13px; }.routine-tabs small { font-size:11px; }
...
.player-avatar b { border-color: var(--color-warning); background: var(--color-warning-soft); }
.routine-delete, .routine-section__head > button, .routine-exercise__remove { color: var(--color-danger-text); }
.player-xp span, .skill-card__track i { background: var(--color-secondary); }
