...
.ui-select__trigger { width: 100%; min-height: 48px; display: flex; align-items: center; gap: 7px; padding: 8px 10px 8px 12px; border: 1px solid var(--border); border-radius: 11px; background: var(--surface); color: var(--text); font: inherit; font-size: 14px; text-align: left; cursor: pointer; transition: border-color .15s, box-shadow .15s, background .15s; }
...
.ui-select__option { width: 100%; min-height: 48px; display: flex; align-items: center; gap: 8px; padding: 7px 9px; border: 0; border-radius: 9px; background: transparent; color: var(--text-mid); font-family: var(--font); font-size: 14px; font-weight: 650; text-align: left; cursor: pointer; }.ui-select__option:hover,.ui-select__option.active { background: var(--surface2); color: var(--text); }.ui-select__option.selected { background: var(--accent-soft); color: var(--accent2); }.ui-select__option > span:nth-child(2),.ui-select__option > span:first-child:last-of-type { min-width: 0; flex: 1; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }.ui-select__option > svg { width: 14px; height: 14px; flex: 0 0 14px; fill: none; stroke: var(--accent2); stroke-width: 2; stroke-linecap: round; stroke-linejoin: round; }
