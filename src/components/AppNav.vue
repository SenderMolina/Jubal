<template>
  <nav class="bottom-nav">
    <RouterLink class="bottom-nav__item" :class="{ active: isActive('/') }" to="/">
...
function isActive(path) {
  if (path === '/') return route.path === '/' || route.path.startsWith('/actividad/')
