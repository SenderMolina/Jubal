...
assert.deepEqual(leader, { editLibrary: true, manageActivities: true, manageBand: true, editBand: false, seeChords: true })
assert.equal(permissionsFor({ role: 'leader', isOwner: true }).editBand, true)

const musician = permissionsFor({ role: 'musician' })
assert.deepEqual(musician, { editLibrary: false, manageActivities: false, manageBand: false, editBand: false, seeChords: true })
...
assert.deepEqual(personal, { editLibrary: true, manageActivities: false, manageBand: false, editBand: false, seeChords: true })
